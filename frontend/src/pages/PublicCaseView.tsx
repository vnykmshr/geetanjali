          ...
          <div className="relative">
              ...
              <div className="relative pl-8 sm:pl-10 pb-3 sm:pb-4">
                ...
                {showPaths && (
                  <div className="mt-2 sm:mt-3 space-y-2 sm:space-y-3">
                    {/* Path selector cards - horizontal scroll on mobile, grid on desktop */}
            ...
            {firstOutput && typeof firstOutput.result_json.recommended_action === 'object' &&
             (firstOutput.result_json.recommended_action.steps?.length ?? 0) > 0 && (
              <div className="relative pl-8 sm:pl-10 pb-3 sm:pb-4">
                <div className="absolute left-0 w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-green-100 border-2 border-green-300 flex items-center justify-center">
