        ...
        <div className="flex gap-1.5 sm:gap-2">
          ...
          {canDelete && (
            <button
              ...
              className="p-2 sm:px-3 sm:py-1.5 bg-white rounded-lg shadow-sm text-gray-400 hover:text-red-600 hover:bg-red-50 border border-gray-200 flex items-center gap-1.5"
          ...
          {canShare && (
            <div className="relative">
              <button
                ...
                className={`p-2 sm:px-3 sm:py-1.5 rounded-lg shadow-sm flex items-center gap-1.5 ${
                  caseData.is_public
              ...
              >
                ...
                <svg className={`w-3 h-3 hidden sm:block transition-transform ${showShareDropdown ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {showShareDropdown && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-64 sm:w-72 bg-white rounded-xl shadow-xl border border-gray-200 z-20 p-3 sm:p-4">
                    {/* Visibility Toggle */}
                      ...
                      <div className="pt-3 border-t border-gray-100">
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            className="flex-1 min-w-0 px-2 py-1.5 border border-gray-200 rounded-lg text-xs bg-gray-50 text-gray-700 font-mono truncate"
                          />
                          <button
                            onClick={onCopyShareLink}
                            className="px-3 py-1.5 bg-amber-600 text-white rounded-lg hover:bg-amber-700 text-xs font-medium flex-shrink-0"
                          >
